...
namespace Zawa\Getui;

use Zawa\Getui\Igetui\Template\{
...
use Zawa\Getui\Igetui\IGtAPNPayload;
use Zawa\Getui\Igetui\Msg\DictionaryAlertMsg;
use Zawa\Getui\Igetui\Msg\SimpleAlertMsg;
    ...
    private function IGtTransmissionTemplate()
    {
        ...
        if (isset($is_ios) && (bool)$is_ios) {
            ...
            if(is_array($custom_msg)){
                ...
                $apn->add_customMsg('payload', $custom_msg );
            }
