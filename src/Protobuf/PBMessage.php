 ...
 */
namespace Zawa\Getui\Protobuf;

use Zawa\Getui\Protobuf\Encoding\Base128varint;

// use Zawa\Getui\Protobuf\Type\{ PBString,PBScalar,PBEnum,PBBytes,PBInt,PBBool,PBSignedInt };

use Zawa\Getui\Protobuf\Type\PBString;
use Zawa\Getui\Protobuf\Type\PBScalar;
use Zawa\Getui\Protobuf\Type\PBEnum;
use Zawa\Getui\Protobuf\Type\PBBytes;
use Zawa\Getui\Protobuf\Type\PBInt;
use Zawa\Getui\Protobuf\Type\PBBool;
use Zawa\Getui\Protobuf\Type\PBSignedInt;

use Zawa\Getui\protobuf\Reader\{ PBInputReader,PBInputStringReader };
...
abstract class PBMessage
{
    ...
    {
        $class = $this->get_namespace($this->fields[$index]).$this->fields[$index];
    ...
    protected function get_namespace($key){
        
        $pb_type = ['PBBool','PBBytes','PBBEnum','PBInt','PBScalar','PBSignedInt','PBString']; 

        if(in_array($key, $pb_type)){
            return "Zawa\\Getui\\Protobuf\\Type\\";
        } 
        return "Zawa\\Getui\\IGetui\\Req\\";
